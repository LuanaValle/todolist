...
class TarefaDAO{
    ...
    // Método responsável pelo acesso aos bancos de dados
    // cada método será responsável por uma query de acordo com o que ele deve retornar
    pegaTodasTarefas = ()=>{
        // como estamos tratando de acesso a banco de dados, o processo é assíncrono,
        // por isso precisamos trabalhar com promises.
        //O método irá retornar a promise, que será executada (com .then e .catch) no controller
    ...
    insereTarefa = (novaTarefa)=>{
        return new Promise((resolve, reject)=>{
            ...
            // NUNCA USER COM TEMPLATE STRING
            // Nós inserimos os dados a serem substituídos depois da query
            // Ou separada por vírgula (QUERY, a,b,c, callback)
